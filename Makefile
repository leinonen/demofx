...
# Source files
SOURCES = main.c font.c menu.c transitions.c plasma.c fire.c tunnel.c starfield.c scroller.c cube.c torus.c raster.c twister.c rotozoom.c metaballs.c dottunnel.c vectorballs.c textwriter.c synth.c sinescroller_large.c metaballs3d.c ripple.c voxel.c bumpmap.c kaleidoscope.c raytracer.c sierpinski.c particles.c tesseract.c matrix.c matrixcode.c lens.c voronoi.c spiky_twister.c sdf_march.c parallax.c morph3d.c reaction_diffusion.c
